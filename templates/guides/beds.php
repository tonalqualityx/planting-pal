...
<div class="indppl-instructions">
  <div class="indppl-instructions-text">
    <h2>Raised Beds Planting Guide Builder</h2>
...
<div id="planting-guide" class="planting-guide-preview planting-guide" data-type="beds" data-store="<?php echo $store; ?>">
    <div class="overflow">
        ...
        <div class="planting-guide-header indppl-flex indppl-justify-center">
            <img src="">
            <h1 class="lobster" style="text-align: center;">Raised Beds Planting Guide</h1>
        </div>
                        ...
                        if($saved_data[$sec]->products){
                            ...
                            if($sec == 1){
                                foreach ($apprates['beds']['filler'] as $k => $v) {
                                    ...
                                    $def_inst = get_post_meta($k, 'wpcf-beds-instructions-step-1-bulk',TRUE);
                                ...
                                foreach($apprates['beds']['blended'] as $k => $v){

                                    $def_inst = get_post_meta($k, 'wpcf-beds-instructions-step-1-blended',TRUE);
                                ...
                                foreach($products_list as $k => $v){
                                    $def_inst = get_post_meta($k, 'wpcf-beds-instructions-step-' . $sec,TRUE);
    ...
    ?>
        <div class="planting-guide-options <?php echo $hide; ?> section-<?php echo $options['id']; ?>" data-step="<?php echo $i; ?>" data-title="<?php echo $format_section; ?>-header" >
            ...
            <ul class="style-free" data-products="products-<?php echo $i; ?>">
                ...
                <li class="planting-guide-instructions indppl-flex indppl-no-wrap indppl-align-start">
