...
function indppl_enqueue(){
    wp_enqueue_style('indppl-style', INDPPL_ROOT_URL . 'css/style.css', array(), "1.1.4");
    ...
    wp_register_script( 'indppl-js', INDPPL_ROOT_URL . 'js/app.js', array( 'jquery' ), "1.1.4.1");
...
function page_template_enqueue(){
    ...
    if(is_page_template("no-header-no-footer-template.php") || $post->post_type == "store"){
        ...
        wp_enqueue_style('indppl-template-style', INDPPL_ROOT_URL . 'assets/css/styles.css', array(), "1.0");
